...
class DeferredRenderingRenderPass : public VulkanBase
{
public:
	DeferredRenderingRenderPass();
	~DeferredRenderingRenderPass();
...
private:
	...
	VulkanRenderPass * m_pCompositeRenderPass = nullptr;
	VulkanFramebuffer * m_pDeferredFramebuffer = nullptr;
	std::vector<VulkanFramebuffer> m_CompositeFramebuffers;

	VulkanSampler * m_pGBufferSampler = nullptr;
	...
	VulkanSemaphore * m_pDeferredCompleteSemaphore = nullptr;
	VulkanFence * m_pDeferredFence = nullptr;

	VulkanCommandBuffer m_DeferredCommandBuffer;
